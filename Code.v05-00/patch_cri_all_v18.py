...
# 3. Patch KPP_Global.cpp
if os.path.exists(global_path):
    print(f"Patching {global_path}...")
    with open(global_path, 'r', encoding='utf-8') as f:
        content = f.read()

    # Clean existing includes if they exist
    ...
    # Define VAR instead of declaring it extern
    content = content.replace("extern double * VAR;", "double * VAR = &C[0];")

    with open(global_path, 'w', encoding='utf-8') as f:
        f.write(content)
    print("Successfully patched KPP_Global.cpp!")

# 4. Patch cri_Global.h
...
# Keep extern double * VAR; in header so it can be referenced by other source files
content = content.replace("extern double * VAR;", "extern double * VAR;")

with open(global_h_path, 'w', encoding='utf-8') as f:
    f.write(content)
print("Successfully patched cri_Global.h!")

# 5. Patch KPP_Monitor.cpp
