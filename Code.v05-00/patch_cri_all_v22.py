...
# Add OMP threadprivate pragma for the variables declared in cri_Global.h
content += """
...
extern int DDMTYPE;
extern double NOON_JRATES[];
extern double PHOTOL[];
extern double HET[NSPEC][3];
extern double SZA_CST[];
