...
Input::Input( unsigned int iCase,               \
    ...
    EI_NOx_        ( parameters[iCase].count("EI_NOX") ? parameters[iCase].at("EI_NOX") : 10.0),
    EI_CO_         ( parameters[iCase].count("EI_CO") ? parameters[iCase].at("EI_CO") : 1.0),
    EI_HC_         ( parameters[iCase].count("EI_UHC") ? parameters[iCase].at("EI_UHC") : 0.6),
    EI_H2_         ( parameters[iCase].count("EI_H2") ? parameters[iCase].at("EI_H2") : 0.0),
    EI_H2O2_         ( parameters[iCase].count("EI_H2O2") ? parameters[iCase].at("EI_H2O2") : 0.0),
    EI_NH3_         ( parameters[iCase].count("EI_NH3") ? parameters[iCase].at("EI_NH3") : 0.0),
    EI_N2O_         ( parameters[iCase].count("EI_N2O") ? parameters[iCase].at("EI_N2O") : 0.0),
    EI_LUB_         ( parameters[iCase].count("EI_LUB") ? parameters[iCase].at("EI_LUB") : 0.0),
    EI_SO2_        ( parameters[iCase].count("EI_SO2") ? parameters[iCase].at("EI_SO2") : 1.2),
    EI_SO2TOSO4_   ( parameters[iCase].count("EI_SO2TOSO4") ? parameters[iCase].at("EI_SO2TOSO4") : 0.02),
    EI_Soot_       ( parameters[iCase].count("EI_SOOT") ? parameters[iCase].at("EI_SOOT") : 0.008),
    sootRad_       ( parameters[iCase].count("EI_SOOTRAD") ? parameters[iCase].at("EI_SOOTRAD") : 20.0E-09),
