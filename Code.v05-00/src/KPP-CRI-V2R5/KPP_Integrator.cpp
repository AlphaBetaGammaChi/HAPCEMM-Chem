...
/*~~~> Function headers */   
 ...
 void SolveTemplate( double A[], int Pivot[], double b[] );
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
int INTEGRATE( double VAR_param[] , double FIX_param[], double TIN   , double TOUT,
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{   
   double Ynew[492], Fcn0[492], Fcn[492],
      dFdT[492],
      Jac0[4937], Ghimj[4937];
   double K[492*ros_S];   
   double H, T, Hnew, HC, HG, Fac, Tau; 
   double Err, Yerr[492];
   int Pivot[492], Direction, ioffset, j, istage;
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
  ...
  /*~~~>   Compute the stages  */
   for (istage = 1; istage <= ros_S; istage++) {
      ...
      /* Current istage offset. Current istage vector is K[ioffset:ioffset+492-1] */
      ioffset = 492*(istage-1);
	 
      /* For the 1st istage the function has been computed previously */
      if ( istage == 1 )
	   WCOPY(492,Fcn0,1,Fcn,1);
      else { /* istage>1 and a new function evaluation is needed at current istage */
	if ( ros_NewF[istage-1] ) {
	   WCOPY(492,Y,1,Ynew,1);
	   for (j = 1; j <= istage-1; j++)
	     WAXPY(492,ros_A[(istage-1)*(istage-2)/2+j-1],
                   &K[492*(j-1)],1,Ynew,1); 
  ...
  /*~~~>  Compute the new solution   */
   WCOPY(492,Y,1,Ynew,1);
   for (j=1; j<=ros_S; j++)
       WAXPY(492,ros_M[j-1],&K[492*(j-1)],1,Ynew,1);

  /*~~~>  Compute the error estimation   */
   WSCAL(492,ZERO,Yerr,1);
   for (j=1; j<=ros_S; j++)    
       WAXPY(492,ros_E[j-1],&K[492*(j-1)],1,Yerr,1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/   
{
  /*~~~> Local variables */     
   ...
   WAXPY(492,(-ONE),Fcn0,1,dFdT,1);
   WSCAL(492,(ONE/Delta),dFdT,1);
...
{   
  ...
  /*~~~>    Construct Ghimj = 1/(H*ham) - Jac0 */
     WCOPY(4937,Jac0,1,Ghimj,1);
     WSCAL(4937,(-ONE),Ghimj,1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/   
{
  ...
  /*~~~> The coefficient matrices A and C are strictly lower triangular.
    ...
    ros_A[0]  = (double)0.1544000000000000e+01;
    ros_A[1]  = (double)0.9466785280815826;
    ros_A[2]  = (double)0.2557011698983284;
    ros_A[3]  = (double)0.3314825187068521e+01;
    ros_A[4]  = (double)0.2896124015972201e+01;
    ros_A[5]  = (double)0.9986419139977817;
    ros_A[6]  = (double)0.1221224509226641e+01;
    ros_A[7]  = (double)0.6019134481288629e+01;
    ros_A[8]  = (double)0.1253708332932087e+02;
  ...
  /*~~~>     C_{i,j} = ros_C[ (i-1)*(i-2)/2 + j -1]  */
    ros_C[0]  = (double)(-0.5668800000000000e+01);
    ros_C[1]  = (double)(-0.2430093356833875e+01);
    ros_C[2]  = (double)(-0.2063599157091915);
    ros_C[3]  = (double)(-0.1073529058151375);
    ros_C[4]  = (double)(-0.9594562251023355e+01);
    ros_C[5]  = (double)(-0.2047028614809616e+02);
    ros_C[6]  = (double)( 0.7496443313967647e+01);
    ros_C[7]  = (double)(-0.1024680431464352e+02);
    ros_C[8]  = (double)(-0.3399990352819905e+02);
    ros_C[9]  = (double)( 0.1170890893206160e+02);
    ros_C[10] = (double)( 0.8083246795921522e+01);
    ros_C[11] = (double)(-0.7981132988064893e+01);
    ros_C[12] = (double)(-0.3152159432874371e+02);
    ros_C[13] = (double)( 0.1631930543123136e+02);
    ros_C[14] = (double)(-0.6058818238834054e+01);
...
{   
  ...
  /*~~~> Note: for a full matrix use Lapack:
      DGETRF( 492, 492, A, 492, Pivot, ising ) */
...
{   
  ...
  /*~~~> Note: for a full matrix use Lapack:
      NRHS = 1
      DGETRS( 'N', 492 , NRHS, A, 492, Pivot, b, 492, INFO ) */
