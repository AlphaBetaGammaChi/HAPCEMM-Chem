...
int InitSaveData()
{
  fpDat = fopen("cri.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : cri.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("cri.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : cri.m");
    exit(1);
  }

  fprintf(fpMatlab, "load cri.dat;\n");
  fprintf(fpMatlab, "%sc = cri;\n", prefix);
  fprintf(fpMatlab, "clear cri;\n");
