...
//        double sSO4 = rSO4/10; /* For normal distributions, sSO4 */
        ...
        gas_aerosol_rhs rhs(
            temperature_K, simVars_.pressure_Pa, delta_T,
            H2O_amb, SO4_amb, SO4l_amb, SO4g_amb, HNO3_amb, Total_Number_Density,
            averaged_radius, KernelSO4Soot, nPDF_Total);    /* using number density of geo and soot particles and radii in positions 9 and 10)*/
