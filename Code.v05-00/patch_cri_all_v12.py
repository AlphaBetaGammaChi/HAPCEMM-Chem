...
shutil.copy(os.path.join(kpp_cri_dir, "cri_Global.c"), global_path)
...
content = content.replace("double C[NSPEC];", "double C[NSPECALL];")
...
content = content.replace("int MONITOR[NMONITOR];", "int MONITOR[NMONITOR];")
