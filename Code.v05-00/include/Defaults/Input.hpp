...
SIMULATION MENU:
  ...
  BOX MODEL SUBMENU:
    ...
    Box model duration [hr] (double): 120.0
    Box model mode (int): 1
    Box model threads (int): 1
    Fuel: C12H24
    Custom Species: []
    Custom Fuel EIs: []
    Box model coupling (T/F): F
    Output variables (string): all
...
METEOROLOGY MENU:
  METEOROLOGICAL PARAMETERS SUBMENU:
    Temperature [K] (double): 223.0
    Relative Humidity [%] (double): 50.0
